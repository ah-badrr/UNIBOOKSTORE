    ...
    <div class="row">
        <div class="col-md-12">
            <div class="white_shd full margin_bottom_30">
                ...
                <form class="padding_infor_info row" action="{{ route('buku.update', $buku->id) }}" method="POST">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input id="kategori" type="text"
                                class="form-control @error('kategori') is-invalid @enderror" value="{{ $buku->kategori }}"
                                name="kategori">
                            @error('kategori')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
